                            ...
                            "children": [
                                {
                                    ...
                                    "href": url_for('products_by_category_and_subcategory', category_id=3,
                                                    subcategory_id=0, page=1, sort_method=0),
                                },
                            ]
                        },
                        {
                            ...
                            "children": [
                                ...
                                },
                                {
                                    "name": "Massas",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=1, page=1, sort_method=0),
                                },
                                {
                                    "name": "Escondidinhos",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=2, page=1, sort_method=0),
                                },
                                {
                                    "name": "Arroz",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=3, page=1, sort_method=0),
                                },
                                {
                                    "name": "Legumes",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=4, page=1, sort_method=0),
                                },
                                {
                                    "name": "Sopas/Cremes",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=5, page=1, sort_method=0),
                                },
                                {
                                    "name": "Refeições combinadas",
                                    "href": url_for('products_by_category_and_subcategory', category_id=4,
                                                    subcategory_id=6, page=1, sort_method=0),
                                },
                            ]
                        },
                        {
