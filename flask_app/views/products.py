...
def products_by_category(category_id, page, sort_method):
    data = products_data_provider.get_products_data_by_category(category_id=category_id, page=page,
...
def products_by_category_and_subcategory(category_id, subcategory_id, page, sort_method):
    data = products_data_provider.get_products_data_by_category_and_subcategory(category_id=category_id,
...
def products_by_search(page, sort_method):
    ...
    data = products_data_provider.get_products_data_by_search(page=page, sort_method=sort_method, q=q)
    return render_template('products/products.html', data=data)
